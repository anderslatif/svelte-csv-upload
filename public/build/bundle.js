...
var app = (function () {
    ...
    */
    ...
    /* src/UploadCSV.svelte generated by Svelte v3.17.1 */

    const { console: console_1 } = globals;
    const file = "src/UploadCSV.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = listen_dev(input, "change", /*uploadFile*/ ctx[1], false, false, false);
    		},
    		p: noop,
    		i: noop,
    		o: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { dataToCSV = [] } = $$props;
    	let prevDataToCSV;
    	let { allowedFileExtensions = ["csv"] } = $$props;
    	...
    	const writable_props = ["onUpload", "dataToCSV", "allowedFileExtensions"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<UploadCSV> was created with unknown prop '${key}'`);
    	});

    	function input_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(0, uploader = $$value);
    		});
    	}

    	$$self.$set = $$props => {
    		if ("onUpload" in $$props) $$invalidate(2, onUpload = $$props.onUpload);
    		if ("dataToCSV" in $$props) $$invalidate(3, dataToCSV = $$props.dataToCSV);
    		if ("allowedFileExtensions" in $$props) $$invalidate(4, allowedFileExtensions = $$props.allowedFileExtensions);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("onUpload" in $$props) $$invalidate(2, onUpload = $$props.onUpload);
    		if ("dataToCSV" in $$props) $$invalidate(3, dataToCSV = $$props.dataToCSV);
    		if ("prevDataToCSV" in $$props) $$invalidate(5, prevDataToCSV = $$props.prevDataToCSV);
    		if ("allowedFileExtensions" in $$props) $$invalidate(4, allowedFileExtensions = $$props.allowedFileExtensions);
    		if ("maxFileSize" in $$props) maxFileSize = $$props.maxFileSize;
    		if ("uploader" in $$props) $$invalidate(0, uploader = $$props.uploader);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*dataToCSV, prevDataToCSV, onUpload*/ 44) {
    			 {
    				if (dataToCSV !== prevDataToCSV && dataToCSV.length !== 0) {
    					$$invalidate(5, prevDataToCSV = dataToCSV);
    					const csvData = papaparse_min.unparse(dataToCSV);
    ...
    class UploadCSV extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*onUpload*/ ctx[2] === undefined && !("onUpload" in props)) {
    			console_1.warn("<UploadCSV> was created without expected prop 'onUpload'");
    		}
    	}

    	get onUpload() {
    		throw new Error("<UploadCSV>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set onUpload(value) {
    		throw new Error("<UploadCSV>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
